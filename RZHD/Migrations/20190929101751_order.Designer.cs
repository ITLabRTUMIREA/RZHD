...
namespace RZHD.Migrations
{
    ...
    [Migration("20190929101751_order")]
    partial class order
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RZHD.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("RZHD.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("RZHD.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("RZHD.Models.StationTicket", b =>
                {
                    b.Property<int>("StationId");

                    b.Property<int>("TicketId");

                    b.HasKey("StationId", "TicketId");

                    b.HasIndex("TicketId");

                    b.ToTable("StationTickets");
                });
            ...
            modelBuilder.Entity("RZHD.Models.Category", b =>
                {
                    b.HasOne("RZHD.Models.Restaurant")
                        .WithMany("Menu")
            ...
            modelBuilder.Entity("RZHD.Models.Product", b =>
                {
                    b.HasOne("RZHD.Models.Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId");

                    b.HasOne("RZHD.Models.Order")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("RZHD.Models.StationTicket", b =>
                {
                    ...
                    b.HasOne("RZHD.Models.Ticket", "Ticket")
                        .WithMany("Stations")
